...
df = pd.read_csv("Data/Cause-wise Distribution_educational_status_2021.csv",encoding="cp1252")
...
print("\nTop 10 States/UTs - Education Dataset:")
...
fig = plt.bar(
    ...
    y="State/UT",
    orientation="h",
    title="Top 10 States/UTs - Education Dataset (2021)",
    labels={
